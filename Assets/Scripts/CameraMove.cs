...
public class CameraMove : MonoBehaviour
{
    ...
    [SerializeField, Range(0f, 60f)] private float pointA = 5f;   // Position du point A du chemin de la plateforme
    [SerializeField, Range(0f, 60f)] private float pointB = 5f;   // Position du point B du chemin de la plateforme
